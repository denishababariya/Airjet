...
const permissions = [
  ...
  'Goods Receipt Note – Full Access',
  'Purchase Returns – Full Access',
  'Inventory & Spare Parts – View/Edit',
  'Reports – Purchase & Inventory Reports',
];
...
const users = [
  { id: 'U010', name: 'Ramesh Kulkarni', email: 'ramesh.kulkarni@airjet.in', lastLogin: '22 Jun 2026, 09:40 AM', status: 'Active' },
  { id: 'U011', name: 'Sunita Verma', email: 'sunita.verma@airjet.in', lastLogin: '21 Jun 2026, 04:15 PM', status: 'Active' },
];
