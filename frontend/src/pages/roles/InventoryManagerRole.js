...
const permissions = [
  ...
  'Part Number Master – Full Access',
  'Part Categories & Brands – Full Access',
  'Compatible Models – Full Access',
  'Warehouse Management – Full Access',
  'Stock Transfers – Full Access',
  'Stock Audits – Full Access',
  'Reports – Inventory & Warehouse Reports',
];
...
const users = [
  { id: 'U015', name: 'Nilesh Gaikwad', email: 'nilesh.gaikwad@airjet.in', lastLogin: '22 Jun 2026, 09:00 AM', status: 'Active' },
  { id: 'U016', name: 'Pooja Tiwari', email: 'pooja.tiwari@airjet.in', lastLogin: '21 Jun 2026, 07:20 PM', status: 'Active' },
];

export default function InventoryManagerRole() {
  return (
    <div>
      <div className="d_page_header">
        <div>
          <div className="d_page_title">Inventory Manager Role</div>
          <div className="d_page_subtitle">Access limited to Inventory, Warehouse, and Reports modules</div>
        </div>
