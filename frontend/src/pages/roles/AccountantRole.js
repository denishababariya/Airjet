...
const permissions = [
  ...
  'Receivables & Payables – Full Access',
  'Ledger – Full Access',
  'GST Reports (GSTR-1, GSTR-3B, GSTR-2A) – Full Access',
  'Profit & Loss Statement – View',
  'Purchase Management – View Only',
  'Sales & Invoices – View Only',
  'Reports – Financial & Tax Reports',
];

const restricted = [
  'Employee Master – No Access',
  'Payroll – No Access',
...
const users = [
  { id: 'U017', name: 'Snehal Jain', email: 'snehal.jain@airjet.in', lastLogin: '22 Jun 2026, 10:20 AM', status: 'Active' },
  { id: 'U018', name: 'Mahesh Pandey', email: 'mahesh.pandey@airjet.in', lastLogin: '21 Jun 2026, 06:00 PM', status: 'Active' },
];

export default function AccountantRole() {
  return (
    <div>
      <div className="d_page_header">
        <div>
          <div className="d_page_title">Accountant Role</div>
          <div className="d_page_subtitle">Access to Accounts & GST, Purchase, Sales, and Reports modules</div>
        </div>
